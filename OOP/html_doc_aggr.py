...
class Head(Tag):
	...
	def __init__(self, title=None):
		super().__init__("head", "")
		if title:
			self._tile_tag = Tag("title", title)
			self.contents = str(self._tile_tag)
...
# 	my_page.add_tag("p", "This is a paragraph that will appear in the page")
...
# 		my_page.display(file=test_doc)
	...
	new_body.add_tag("p", "The composed object doesn't actually own the objects that it's composed of"
					 " - if it's destoyed, those objects continue to exist")
